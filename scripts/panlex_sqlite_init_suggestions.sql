...
-- In the PanLex DB ±90% of the words have denotation_count ≤ 5
-- Which means the user most likely does not care about them
-- So we can safely ignore them in order to improve the suggestions
-- selection by 5-10x (it's measured).
