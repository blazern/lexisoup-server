...
def main() -> None:
    ...
    migrate_panlex_db(panlex_sqlite_db_path, panlex_sqlite_db_migration_script_path)
...
def migrate_panlex_db(panlex_sqlite_db_path: Path, panlex_sqlite_db_migration_script_path: Path) -> None:
